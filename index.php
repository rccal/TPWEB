...
<section style="padding-top:60px; ">
                    <div class="card bg-dark">
                        <div class="card-header">
                            <h1 class="text-center text-white">MIS CURSOS VI SEMERSTRE</h1>
                            </div>
                            <div class="container">
                            <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card m-3 " style="width: 18rem;">
                                            <img class="card-img-top" src="img/web-administracion.png" alt="Card image cap" height="170" >
                                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="card m-3 " style="width: 18rem;">
                                            <img class="card-img-top" src="img/717db8363ed76968498858169467b992.png" alt="Card image cap" height="170">
                                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="card m-3 " style="width: 18rem;">
                                            <img class="card-img-top" src="img/taller-de-programacin-web-sesion-78910-11-1-728.jpg" alt="Card image cap" height="170" >
                                            <div class="card-body">
